                            ...
                            <div class="round_bottom">
                                ...
                                                    <option value="1" <% nvram_match_x("","rt_wdsapply_x", "1","selected"); %>><#checkbox_Yes#></option>
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
										...
										<tr>
                                            <td colspan="3">
                                                <i class="icon-hand-right"></i> <a href="javascript:spoiler_toggle('ap_script')"><span>ap_script 【Нажмите, чтобы открыть конфигурационный скрипт】</span>
                                                <div>
                                                    &nbsp;<span style="color:#888;">Дополнительные функции: скрипт автоматического переключения сигнала ретранслятора 【автопоиск канала, автопоиск сигнала】</span>
                                                </div></a>
