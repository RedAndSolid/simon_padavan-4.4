                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="alert alert-info" style="margin: 10px;">
                                        ...
                                        <ol>
                                            ...
                                            <li><#FW_desc5#></li>
                                            <li><#FW_desc6#></li>
											<li>Подсказка журнала сбоев прошивки:Обновление прошивки: Образ прошивки повреждён! Проверьте свободное место в /tmp!
											Нажмите кнопку справа, чтобы временно увеличить пространство /tmp，затем загрузите прошивку заново！<input id="bingtmp" class="btn btn-success" style="width:50px display:none;" type="button" name="bingtmp" value="扩大/tmp" onclick="submitInternet('bigtmp');" /></li>
                                        </ol>
                                    </div>
